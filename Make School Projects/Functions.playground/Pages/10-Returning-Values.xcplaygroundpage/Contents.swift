...
func degreesToRadians(dgree: Double)->Double{
    let radians: Double = (dgree / 180) * M_PI
    return radians
}
...
func calculateRotationForPolygon(sides: Int)->Double{
    let rotation: Double = Double(180 - 180 * (sides - 2) / sides)
    return rotation
}

calculateRotationForPolygon(8)
calculateRotationForPolygon(4)
calculateRotationForPolygon(3)
calculateRotationForPolygon(10)
calculateRotationForPolygon(800)
